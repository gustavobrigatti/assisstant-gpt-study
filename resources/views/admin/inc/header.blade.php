    ...
    <div class="header-container container-xxl">
        ...
        <div
            ...
            <h1 class="d-flex flex-column text-dark fw-bold my-1">
                <span class="text-white fs-1">{{$title ?? 'Dashboard'}}</span>
                <ol class="breadcrumb text-muted fs-6 fw-bold">
                    <li class="breadcrumb-item pe-3">
                        <a href="{{route('admin.index')}}" class="pe-3"><i class="fas fa-home"></i></a>
                    </li>
                    @if(isset($breadcrumbs) && count($breadcrumbs) > 0 )
                        @foreach($breadcrumbs as $breadcrumb)
                            <li class="breadcrumb-item pe-3"><a href="{{$breadcrumb['url']}}" class="pe-3" style="color: #a1a5b7">{{$breadcrumb['title']}}</a></li>
                        @endforeach
                    @endif
                </ol>
            </h1>
            ...
            <div class="header-search py-3 py-lg-0 me-3">
                ...
                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-250px"
                    ...
                    <form data-kt-search-element="form" class="w-100 position-relative" autocomplete="off">
                        ...
                        <!--end::Icon-->
                        <!--begin::Input-->
                        <input type="text" class="form-control custom-form-control ps-13" name="search" value=""
            ...
            <div class="d-flex align-items-center py-3 py-lg-0">
                ...
                <div class="me-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('auth.logout') }}" class="menu-link px-5">Sair</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
