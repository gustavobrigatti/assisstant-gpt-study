...
$config['licenseName'] = 'named';
$config['licenseKey']  = '*C?E-*1**-M**F-*N**-*M**-K*V*-3**R';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/public/images/galery/',
    #'root'         => '/images/galery/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
